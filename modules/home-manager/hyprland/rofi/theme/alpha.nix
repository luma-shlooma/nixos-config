  ...
  programs.rofi = {
    ...
    in {
      ...
      "*" = {
        ...
        bg0 = mkLiteral "#${colours.black}";
        bg1 = mkLiteral "#${colours.light-black}";
        fg0 = mkLiteral "#${colours.white}";
        accent-color = mkLiteral "#${colours.blue}";
        urgent-color = mkLiteral "#${colours.yellow}";
